  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden' >
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 
        ...
        <ul className={`hidden lg:flex items-center gap-6 lg:gap-12 rounded-full 
        ...
        className='w-6 group-hover:rotate-[15deg] transition-transform' />
          ...
          <button className='block lg:hidden ml-3 hover:scale-110 active:scale-95 transition-transform' 
          onClick={openMenu}>
          <Image src={isDarkMode ? assets.menu_white : assets.menu_black} alt="" className='w-6'/>
          </button>
        </div>
 
        <ul ref={sideMenuRef} className ='flex lg:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 
